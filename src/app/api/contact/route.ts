  ...
  try {
    ...
    const htmlBody = `
      ...
      <html>
        ...
        <body style="font-family: Georgia, serif; background: #0A0A0A; color: #ffffff; padding: 40px 20px; margin: 0;">
          <div style="max-width: 600px; margin: 0 auto; background: #111111; border: 1px solid #333; padding: 40px;">
      ...
      <html>
        <body style="font-family: Georgia, serif; background: #0A0A0A; color: #ffffff; padding: 40px 20px; margin: 0;">
          <div style="max-width: 600px; margin: 0 auto; background: #111111; border: 1px solid #333; padding: 40px;">
            ...
            <div style="margin-top: 32px; padding: 20px; background: #0A0A0A; border-left: 2px solid #C9A84C;">
