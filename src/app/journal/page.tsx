...
const articles: JournalArticle[] = [
  {
    ...
    excerpt:
      "Heat and cold, alternated with intention — how contrast therapy supports recovery, circulation, and resilience.",
  },
  {
    ...
    excerpt:
      "Dry sauna and infrared — two heat therapy paths, different temperatures, different rituals.",
  },
  {
    ...
    excerpt:
      "Cold plunge as recovery infrastructure — what the evidence suggests, and how to design for daily use.",
  },
  {
    ...
    excerpt:
      "Earth-tone palettes, outdoor pavilions, and integrated contrast — the quiet direction of luxury wellness design.",
  },
  {
    ...
    excerpt:
      "Private recovery suites for high performers — what belongs in a world-class home environment.",
  },
  {
    ...
    excerpt:
      "Care and longevity for timber, heaters, and ventilation — keeping your sauna performing for decades.",
  },
];
...
export default function JournalPage() {
  return (
    <div className="min-h-screen bg-cream">
      ...
      />
      <JournalGrid articles={articles} basePath="/journal" />
    </div>
  );
}
