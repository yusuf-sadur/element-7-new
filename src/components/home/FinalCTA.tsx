      ...
      <div className="container-e7 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="scroll-reveal">
            ...
            <div className="space-y-3">
              {[
                ...
                <Link
                  key={link.label}
                  href={link.href}
                  className="flex items-center gap-2 text-sand/50 hover:text-gold text-sm transition-colors duration-300 group"
                >
                  <ArrowRight
                    size={14}
            ...
            {/* Contact info */}
            <div className="mt-10 pt-8 border-t border-sand/[0.08] space-y-3">
              <a
                href="tel:+611300000000"
                className="flex items-center gap-3 text-sm text-sand/50 hover:text-gold transition-colors"
              >
                <span className="text-xs text-sand/25 tracking-widest uppercase w-12">
                  Phone
                </span>
                1300 000 000
              </a>
